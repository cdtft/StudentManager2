...
<body>
<div>
    <span>${scoreFormVo.stdName}的成绩单：</span>
</div>

<form class="form-horizontal" role="form" id="scoreForm"
      action="${pageContext.request.contextPath}/score/updateScore/${scoreFormVo.stdId}">
    <c:forEach items="${scoreFormVo.scoreList}" var="objScore">
